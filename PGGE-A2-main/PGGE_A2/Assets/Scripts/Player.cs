...
/*
    Player - Handles the actions of the player, like shooting and reloading, but in singleplayer.
*/
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Aim();
        CheckButtonClicked();
        //X: Moved check clicked button into a seperate method instead of in Update.
